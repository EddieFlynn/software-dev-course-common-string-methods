...
let replacedString = inputString.replaceAll("JavaScript", "Coding");

// 3. Breaking Apart
let wordsArray = inputString.split(" ");

// 4. Retrieving
let firstCharacter = inputString.charAt(Number("0"));
let bootcampIndex = inputString.indexOf("Bootcamp"); 
let bootcampLength = "Bootcamp".length;
let extractedBootcamp = inputString.slice(bootcampIndex, bootcampIndex + bootcampLength);
